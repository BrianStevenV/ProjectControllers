...
public class Employee {
    ...
    public Employee(String id, String firstName, String lastName, String phone, String email, String residencyAddress, String cityLocation, String lengthService, String rh, String employeeType) {
        this.id = id;
